...
(function () {
  ...
  const LECTURE_2_DATA = {
    ...
    ,{heading:'Real-World: Hubble Space Telescope — The Missing Stakeholder Class Cost $629 Million',paragraphs:['The Hubble Space Telescope primary mirror was polished to the wrong prescription because a testing instrument calibration error went undetected. The stakeholder analysis did not include an Independent Verification Authority as a distinct actor with the authority to require independent calibration confirmation. The sole contractor performing the polishing was the sole authority on their own test results. No requirement stated: \'The primary mirror null corrector calibration shall be verified by an independent optical test method before polishing commences.\'','The corrective optics mission (COSTAR, STS-61, December 1993) cost $629 million. A complete stakeholder analysis identifying five INCOSE classes — including the missing Regulatory stakeholder with verification authority independent of the contractor — and a single derived requirement for independent calibration verification would have cost approximately 40 person-hours. This is the professional case for the INCOSE stakeholder taxonomy: it is not a theoretical framework. It is a requirements discovery checklist that prevents program-defining failures.'],callout:{type:'gold',label:'INCOSE Five Stakeholder Classes — Applied to Hubble',body:'Primary: NASA Science Institute (defines science requirements). Secondary: International astronomy community (affected by wavelength, scheduling). Regulatory: NASA Office of Safety and Mission Assurance (independent safety verification authority). Support: Perkin-Elmer (performs polishing work, does not define mission requirements). Enabling: Space Shuttle program (provides launch and on-orbit servicing). Missing from HST: Regulatory stakeholder with explicit authority to require independent verification of critical test equipment calibrations. Adding this class generates the requirement that prevents the mirror error.'}},{heading:'Real-World: Hubble Space Telescope — The Missing Stakeholder Class Cost $629 Million',paragraphs:['The Hubble Space Telescope primary mirror was polished to the wrong prescription because a testing instrument calibration error went undetected. The stakeholder analysis did not include an Independent Verification Authority as a distinct actor with the authority to require independent calibration confirmation. The sole contractor performing the polishing was the sole authority on their own test results. No requirement stated: \'The primary mirror null corrector calibration shall be verified by an independent optical test method before polishing commences.\'','The corrective optics mission (COSTAR, STS-61, December 1993) cost $629 million. A complete stakeholder analysis identifying five INCOSE classes — including the missing Regulatory stakeholder with verification authority independent of the contractor — and a single derived requirement for independent calibration verification would have cost approximately 40 person-hours. This is the professional case for the INCOSE stakeholder taxonomy: it is not a theoretical framework. It is a requirements discovery checklist that prevents program-defining failures.'],callout:{type:'gold',label:'INCOSE Five Stakeholder Classes — Applied to Hubble',body:'Primary: NASA Science Institute (defines science requirements). Secondary: International astronomy community (affected by wavelength, scheduling). Regulatory: NASA Office of Safety and Mission Assurance (independent safety verification authority). Support: Perkin-Elmer (performs polishing work, does not define mission requirements). Enabling: Space Shuttle program (provides launch and on-orbit servicing). Missing from HST: Regulatory stakeholder with explicit authority to require independent verification of critical test equipment calibrations. Adding this class generates the requirement that prevents the mirror error.'}}],
